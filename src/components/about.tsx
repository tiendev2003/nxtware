...
export default function About() {
  return (
    <section id="about" className="py-12 md:py-20 lg:py-24 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center mb-12 md:mb-16">
          ...
          >
            <h3 className="text-xl sm:text-2xl font-bold mb-3 md:mb-4 text-gray-900 dark:text-white">
          ...
          <motion.div
            ...
            className="relative order-1 lg:order-2 mx-auto lg:mx-0 max-w-md lg:max-w-none"
          >
            <div className="rounded-xl overflow-hidden shadow-xl">
              ...
              <div className="aspect-[4/3] bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center text-white">
                <span className="text-2xl sm:text-3xl md:text-4xl font-bold opacity-30">NxtWare Team</span>
              </div>
            </div>
            ...
            <motion.div
              ...
              className="absolute -bottom-6 sm:-bottom-8 -left-4 sm:-left-8 bg-white dark:bg-gray-900 p-4 sm:p-6 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 w-[80%] sm:max-w-xs"
            >
        ...
        <div className="mt-16 md:mt-24">
          <h3 className="text-xl sm:text-2xl font-bold mb-6 md:mb-8 text-center text-gray-900 dark:text-white">
            Đội ngũ lãnh đạo
          </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-700 mx-auto w-full max-w-xs"
              >
                <div className="aspect-[3/2] bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                  ...
                  <span className="text-xl sm:text-2xl font-bold text-gray-400 dark:text-gray-500">{member.name}</span>
                </div>
          ...
          >
            <Link
              href="/team"
              className="inline-block px-5 py-2.5 sm:px-6 sm:py-3 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-200 text-sm sm:text-base font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-all"
            >
              Xem toàn bộ đội ngũ
            </Link>
          </motion.div>
